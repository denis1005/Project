        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatrgoryId = table.Column<int>(nullable: false),
                    CategoryId = table.Column<int>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    OrderDetailesId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_OrderDetailes_OrderDetailesId",
                        column: x => x.OrderDetailesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_OrderDetailesId",
                table: "Products",
                column: "OrderDetailesId");
